...
public class SelectBuilder2 implements Reusable {
    ...
    public SelectBuilder2 setIdentitiesList(List<IdentityKey> instruments) {
        this.ids = instruments.isEmpty() ? null : TBWGUtils.match(stream, instruments);
        return this;
    }
    ...
    public SelectBuilder2 setSymbols(List<String> symbols) {
        ids = symbols != null ? symbols.toArray(new String[symbols.size()]) : null;
        return this;
    }
...
//        public Type.Field instrumentType() {
//            return instrumentTypeField;
//        }
