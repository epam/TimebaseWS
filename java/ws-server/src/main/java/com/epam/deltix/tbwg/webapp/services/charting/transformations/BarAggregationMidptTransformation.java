 ...
 */
public class BarAggregationMidptTransformation extends AbstractChartTransformation<BarElementDef, BboPoint> {
    ...
    public BarAggregationMidptTransformation(String symbol, long periodicity, long startTime, long endTime) {
    ...
    protected void onNextPoint(BboPoint point) {
        ...
        if (point.getAskPrice() != Decimal64Utils.NULL && point.getBidPrice() != Decimal64Utils.NULL) {
            update(
                point.getTimeStampMs(),
                Decimal64Utils.divide(Decimal64Utils.add(point.getAskPrice(), point.getBidPrice()), Decimal64Utils.TWO)
            );
        }
    }
