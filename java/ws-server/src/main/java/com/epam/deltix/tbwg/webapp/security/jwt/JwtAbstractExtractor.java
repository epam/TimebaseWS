...
abstract class JwtAbstractExtractor implements JwtExtractor {
    ...
    public Collection<GrantedAuthority> extractAuthorities(Jwt jwt) {
        List<GrantedAuthority> authorities = getPermissions(jwt, settings.getPermissionsClaim());
        Collection<GrantedAuthority> tokenAuthorities = jwtGrantedAuthoritiesConverter.convert(jwt);
