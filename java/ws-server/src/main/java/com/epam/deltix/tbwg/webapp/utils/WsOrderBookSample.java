...
public class WsOrderBookSample implements StompSessionHandler {

    private static final Log LOG = LogFactory.getLog(WsOrderBookSample.class);
    ...
    public void afterConnected(StompSession session, StompHeaders connectedHeaders) {
        ...
        StompHeaders headers = new StompHeaders();
        headers.put("destination", Arrays.asList("/user/topic/charting/BINANCE"));
        headers.put("instrument", Arrays.asList("BTCTUSD"));
        headers.put("chartType", Arrays.asList("BARS"));
//        headers.put("startTime", Arrays.asList("2022-01-01T00:00:00.0Z"));
//        headers.put("endTime", Arrays.asList("2023-11-06T20:00:00.0Z"));
        headers.put("pointInterval", Arrays.asList("30000"));
        headers.put("levels", Arrays.asList("10"));
