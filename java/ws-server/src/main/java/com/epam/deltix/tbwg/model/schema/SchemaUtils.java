...
import com.epam.deltix.tbwg.model.schema.changes.FieldChangeWrapper;
import com.epam.deltix.tbwg.model.schema.changes.FieldTypeChangeDef;
import com.epam.deltix.tbwg.model.schema.changes.CreateFieldChangeDef;
import com.epam.deltix.tbwg.model.schema.changes.FieldModifierChangeDef;

import javax.annotation.Nullable;
import java.util.*;

import static com.epam.deltix.tbwg.model.schema.SchemaBuilder.getDataTypeDef;
...
public final class SchemaUtils {
    ...
    public static FieldDef fieldDef(NonStaticDataField dataField) {
        return FieldDef.createNonStatic(dataField.getName(), dataField.getTitle(), getDataTypeDef(dataField.getType()));
    }

    public static FieldDef fieldDef(StaticDataField dataField) {
        return FieldDef.createStatic(dataField.getName(), dataField.getTitle(), getDataTypeDef(dataField.getType()),
