...
public class RegexTreeFilter extends SearchTreeFilter {
    ...
    public RegexTreeFilter(String filter, boolean matchExactly) {
        super(filter, matchExactly);
        this.filter = matchExactly ? makeExactlyRegex(filter) : filter;
