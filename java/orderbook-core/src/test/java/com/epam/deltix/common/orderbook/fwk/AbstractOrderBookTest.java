 ...
 * the License.
 */
package com.epam.deltix.common.orderbook.fwk;
...
import com.epam.deltix.common.orderbook.options.OrderBookOptions;
...
public abstract class AbstractOrderBookTest {
    ...
    public void assertExchangeBookSize(final long exchangeId, final QuoteSide side, final int expectedSize) {
        final Optional<? extends Exchange<OrderBookQuote>> exchange = getBook().getExchanges().getById(exchangeId);
