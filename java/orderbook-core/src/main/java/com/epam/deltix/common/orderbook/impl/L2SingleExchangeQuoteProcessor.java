...
public class L2SingleExchangeQuoteProcessor<Quote extends MutableOrderBookQuote> implements L2Processor<Quote> {
    ...
    public Quote processL2EntryNewInfo(final L2EntryNewInfo l2EntryNewInfo) {
        ...
        final Optional<MutableExchange<Quote, L2Processor<Quote>>> exchange = getOrCreateExchange(exchangeId);
     ...
     */
    private Optional<MutableExchange<Quote, L2Processor<Quote>>> getOrCreateExchange(final long exchangeId) {
