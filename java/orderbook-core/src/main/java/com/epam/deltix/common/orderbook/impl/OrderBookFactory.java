...
import com.epam.deltix.common.orderbook.options.*;
...
public class OrderBookFactory {
    ...
    /**
     * Factory method for create the order book quote pool with given initial capacity.
     *
     * @return a new order book quote pool instance.
     * @see OrderBook
     * @see MutableOrderBookQuote
     */
    private static ObjectPool<? super OrderBookQuote> createQuotePool(final int initialCapacity) {
        return new ObjectPool<>(initialCapacity, MutableOrderBookQuoteImpl::new);
    }
