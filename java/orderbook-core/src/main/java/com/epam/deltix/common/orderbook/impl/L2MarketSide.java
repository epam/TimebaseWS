...
interface L2MarketSide<Quote> extends MarketSide<Quote> {
    ...
    short binarySearchLevelByPrice(Quote find); //TODO Refactor It's Strange method Hmm...

    short binarySearchNextLevelByPrice(Quote find); //TODO Refactor It's Strange method Hmm...
