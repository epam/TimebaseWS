...
import com.epam.deltix.common.orderbook.options.Defaults;
...
//        getMarketSide(side).updateMaxDepth(); // Todo Refactor
    }
    ...
    abstract void removeQuote(final Quote remove, final L2MarketSide<Quote> marketSide);
    ...
    public L2Processor<Quote> getOrCreateExchange(final long exchangeId) {
        ...
        Optional<MutableExchange<Quote, L2Processor<Quote>>> exchangeHolder = exchanges.getById(exchangeId);
