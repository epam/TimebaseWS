import { AfterViewInit, Component, OnDestroy, OnInit, Sanitizer, ViewChild } from '@angular/core';
...
export class ClControlPanelComponent implements OnInit, OnDestroy {
  ...
  public onAddClass(isEnum?: boolean) {
    ...
    this.appStore.dispatch(AddNewSchemaItem({
      isEnum: !!isEnum,
      ...FORM_VALUE,
    }));
  }
