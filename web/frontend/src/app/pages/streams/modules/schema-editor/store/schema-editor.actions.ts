...
export const GetDefaultTypes = createAction(
  SchemaEditorActionTypes.GET_DEFAULT_TYPES,
);
export const SetDefaultTypes = createAction(
  SchemaEditorActionTypes.SET_DEFAULT_TYPES, props<{ defaultTypes: DefaultTypeModel[] }>(),
);
...
export const SetSchema = createAction(
  SchemaEditorActionTypes.SET_SCHEMA, props<{ schema: { types: SchemaClassTypeModel[], all: SchemaClassTypeModel[] } }>(),
);
...
export const AddChangedValues = createAction(
  SchemaEditorActionTypes.ADD_CHANGED_VALUES, props<{ groupName: string, name: string, value: any }>(),
);
export const SaveSchemaChanges = createAction(
  SchemaEditorActionTypes.SAVE_SCHEMA_CHANGES, props<{ background: boolean, successAction?: () => void }>(),
);
export const SetSchemaDiff = createAction(
  SchemaEditorActionTypes.SET_SCHEMA_DIFF, props<{ diff: StreamMetaDataChangeModel }>(),
);
...
export const CreateStream = createAction(
  SchemaEditorActionTypes.CREATE_STREAM, props<{ key: string }>(),
);

export const SetStreamId = createAction(
  SchemaEditorActionTypes.SET_STREAM_ID, props<{ streamId: string }>(),
);
export const SetSelectedSchemaItem = createAction(
  SchemaEditorActionTypes.SET_SELECTED_SCHEMA_ITEM, props<{ itemName: string }>(),
);
export const SetSelectedFieldForSchemaItem = createAction(
  SchemaEditorActionTypes.SET_SELECTED_FIELD_OF_SCHEMA_ITEM, props<{ fieldUuid: string }>(),
);

export const ChangeClassName = createAction(
  SchemaEditorActionTypes.CHANGE_CLASS_NAME, props<{ classItem: SchemaClassTypeModel, newName: string }>(),
);

export const ChangeEnumName = createAction(
  SchemaEditorActionTypes.CHANGE_ENUM_NAME, props<{ enumItem: SchemaClassTypeModel, newName: string }>(),
);
...
export const ChangeSchemaItem = createAction(
  SchemaEditorActionTypes.CHANGE_SELECTED_SCHEMA_ITEM_PROPS, props<{ itemName: string, item: SchemaClassTypeModel }>(),
);

export const AddNewFieldForSelectedSchemaItem = createAction(
  SchemaEditorActionTypes.ADD_NEW_FIELD_FOR_SELECTED_SCHEMA_ITEM, props<{
    isStatic: boolean,
    name: string,
    value?: string,
  }>(),
...
export const ChangeSelectedFieldProps = createAction(
  SchemaEditorActionTypes.CHANGE_SELECTED_FIELD_PROPS, props<{
    uuid: string,
...
export const AddNewSchemaItem = createAction(
  SchemaEditorActionTypes.ADD_NEW_SCHEMA_ITEM, props<{
    isEnum: boolean,
    name: string,
    title: string,
    isUsed?: boolean,
...
export const EditSchemaResetState = createAction(
  SchemaEditorActionTypes.EDIT_SCHEMA_RESET_STATE,
);

export const EditSchemaUpdateState = createAction(
  SchemaEditorActionTypes.EDIT_SCHEMA_UPDATE_STATE, props<{
