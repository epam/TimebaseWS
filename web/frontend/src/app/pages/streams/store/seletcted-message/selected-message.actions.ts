...
export const loadSelectedMessages = createAction('[SelectedMessage] Load SelectedMessages');
...
export const SetSelectedMessage = createAction(
  ...
  props<{selectedMessage: StreamDetailsModel; columns?: Column[]}>(),
);

export const CleanSelectedMessage = createAction(SelectedMessageActionTypes.CLEAN_SELECTED_MESSAGE);
