...
export enum StreamsTabsActionTypes {
  ...
  SET_DATA_LOADING_STATE_TO_FILTER = '[Streams:Tabs:Filter] Set Data Loading State',
...
export class UpdateTab implements Action {
  readonly type = StreamsTabsActionTypes.UPDATE_TAB;
...
export class RemoveTabs implements Action {
  readonly type = StreamsTabsActionTypes.REMOVE_TABS;
...
export class SetDataLoadingStateTotFilter implements Action {
  readonly type = StreamsTabsActionTypes.SET_DATA_LOADING_STATE_TO_FILTER;
